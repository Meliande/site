  ...
  return (
    <motion.div
      className='
        ...
        '
      initial={{x:0, y:0}}
      whileInView={{x:positionX, y:positionY, transition: {duration: 1.5}}}
    > 
      {name}
    </motion.div>
  )
  ...
  return ( 
    <>
      ...
      <div className="
        ...
        <Skill name='TailwindCSS' positionX="-20vw" positionY="-15vw"/>
        <Skill name='NextJS' positionX="15vw" positionY="-12vw"/>
        <Skill name='Figma' positionX="0vw" positionY="-20vw"/>
        <Skill name='JavaScript' positionX="32vw" positionY="-5vw"/>
      </div>
    </>
   );
}
